...
const Footer = () => (
  <footer className="page-footer py-3 text-center fixed-bottom">
    ...
    <ul className="nav justify-content-center ">
      <li className="nav-item border-right">
        <a
          className="nav-link footer-information"
      ...
      <li className="nav-item border-right">
        <a
          className="nav-link footer-information"
          href="https://www.shopdisney.com/uptown-disney/?src=starwars&CMP=OTL-Dcom&att=StarWars_Footer_Store"
          target="_blank"
          rel="noreferrer"
        >
